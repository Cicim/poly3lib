...
static CMDS_COMMON: &[StaticScriptCommand] = &[
    ...
    /*0x08*/ cmd!("gotostd", Byte, Stop),
    /*0x09*/ cmd!("callstd", Byte),
    /*0x0A*/ cmd!("gotostd_if", Byte, Byte),
    /*0x0B*/ cmd!("callstd_if", Byte, Byte),
    /*0x0C*/ cmd!("gotoram", Stop),
    /*0x0D*/ cmd!("killscript", Stop),
    /*0x0E*/ cmd!("setmysteryeventstatus", Byte),
    /*0x0F*/ cmd!("loadword", Byte, Word),
    ...
    /*0x9B*/ cmd!("messageautoscroll", Word),
